...
export const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    "img-src 'self' blob: data: https://*.public.blob.vercel-storage.com https://public.blob.vercel-storage.com https://*.tile.openstreetmap.org",
    "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://va.vercel-scripts.com",
    "font-src 'self'",
