...
export const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    "img-src 'self' blob: data: https://previewfiles.adventurespark.org https://files.adventurespark.org https://*.r2.dev https://*.tile.openstreetmap.org https://*.tile.opentopomap.org https://server.arcgisonline.com https://pagead2.googlesyndication.com https://tpc.googlesyndication.com https://ep1.adtrafficquality.google",
