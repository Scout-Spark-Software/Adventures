...
<div class="relative overflow-hidden hero-bg -mt-16">
  ...
  <div
    class="absolute -top-32 right-0 w-[700px] h-[700px] rounded-full pointer-events-none"
    style="background: radial-gradient(circle at 70% 30%, rgba(251,191,36,0.18) 0%, rgba(251,146,60,0.08) 35%, transparent 65%);"
  ></div>

  <!-- Forest floor green ambient — bottom left -->
  <div
    class="absolute bottom-0 -left-20 w-[600px] h-[500px] pointer-events-none"
    style="background: radial-gradient(ellipse at 20% 90%, rgba(52,211,153,0.2) 0%, rgba(16,185,129,0.08) 40%, transparent 70%);"
  ></div>
  ...
  <div class="absolute bottom-0 left-0 right-0 pointer-events-none">
    ...
    <svg class="absolute bottom-0 w-full" viewBox="0 0 1440 320" preserveAspectRatio="none">
      <path
        d="M0,320 L0,200 L120,140 L240,180 L360,100 L480,150 L600,80 L720,130 L840,70 L960,120 L1080,90 L1200,140 L1320,110 L1440,160 L1440,320 Z"
    ...
    <svg class="absolute bottom-0 w-full" viewBox="0 0 1440 280" preserveAspectRatio="none">
      <path
        d="M0,280 L0,220 L180,160 L320,200 L500,130 L660,175 L800,110 L980,160 L1120,125 L1260,170 L1440,140 L1440,280 Z"
    ...
    <svg class="absolute bottom-0 w-full" viewBox="0 0 1440 200" preserveAspectRatio="none">
      <path
        d="M0,200 L0,160 L200,120 L380,150 L520,100 L680,140 L820,90 L1000,135 L1140,105 L1300,145 L1440,120 L1440,200 Z"
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-0">
    ...
    <div class="flex justify-center lg:justify-start mb-10">
      <span
        class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold tracking-wide uppercase border"
        style="background: rgba(251,146,60,0.1); border-color: rgba(251,146,60,0.25); color: rgb(251,146,60);"
      >
    ...
    <div class="text-center lg:text-left max-w-4xl">
      <h1
        class="font-black tracking-tight leading-[0.95] mb-6"
        style="font-size: clamp(3rem, 8vw, 6rem); color: #f5f0e8;"
      >
        Your Compass to<br />
        <span
      ...
      <p
        class="text-lg sm:text-xl max-w-xl mx-auto lg:mx-0 leading-relaxed mb-2"
        style="color: rgba(245,240,232,0.7);"
      >
        Trails, campsites, and backpacking routes handpicked for the wilderness-bound scout
      </p>
      <p
        class="text-sm max-w-xl mx-auto lg:mx-0 leading-relaxed mb-10"
      ...
      <div class="flex flex-col gap-3 items-center lg:items-start mb-16">
        <a
          href="/hikes"
          class="group inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm text-stone-950 transition-all hover:scale-105"
        ...
        <div class="flex gap-3 flex-wrap justify-center lg:justify-start">
          <a
            href="/submit"
            class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-bold text-sm transition-all"
            style="background: rgba(245,240,232,0.07); border: 1px solid rgba(245,240,232,0.15); color: rgba(245,240,232,0.85);"
          >
          ...
          <a
            href="/essentials"
            class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-bold text-sm transition-all"
            style="background: rgba(251,146,60,0.1); border: 1px solid rgba(251,146,60,0.25); color: rgba(251,146,60,0.9);"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
  ...
  <div class="relative h-20 overflow-hidden">
    ...
    >
      <path
        d="M0,80 L0,40 Q180,0 360,30 Q540,60 720,25 Q900,-5 1080,35 Q1260,70 1440,30 L1440,80 Z"
        fill="#fafaf9"
      />
    </svg>
  </div>
