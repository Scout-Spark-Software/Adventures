<script lang="ts">
  ...
  import { Backpack, Plus, BookOpen, LayoutGrid, List, Map } from "lucide-svelte";
        ...
        {#if data.backpackingEntries && data.backpackingEntries.length > 0}
          ...
          <div class="flex items-center mb-4">
            <p class="text-sm text-stone-500">
              <span class="font-black text-stone-800">{data.backpackingEntries.length}</span>
              {data.backpackingEntries.length === 1 ? "route" : "routes"} found
            </p>
