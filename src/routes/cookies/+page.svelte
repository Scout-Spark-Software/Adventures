<script lang="ts">
  import cookieHtml from "./cookie.html?raw";
</script>

<svelte:head>
  <title>Cookie Policy - Adventure Spark</title>
  <meta
    name="description"
    content="Cookie Policy for Adventure Spark — how we use cookies and session data."
  />
</svelte:head>
  ...
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="space-y-10">
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        <a
          href="/privacy"
          class="rounded-xl p-5 border border-stone-200 bg-white hover:border-emerald-200 hover:shadow-sm transition-all group"
        >
          <p
            class="font-semibold text-stone-800 text-sm mb-1 group-hover:text-emerald-700 transition-colors"
          >
            Privacy Policy
          </p>
          <p class="text-xs text-stone-400">How we collect and use your personal data.</p>
        </a>
      </div>
    </div>
  </div>
...
<style>
  ...
  /* Use site font instead of Termly's Arial */
  .termly-policy :global([data-custom-class="body_text"]),
  .termly-policy :global([data-custom-class="body_text"] *),
  .termly-policy :global([data-custom-class="heading_1"]),
  .termly-policy :global([data-custom-class="heading_1"] *),
  .termly-policy :global([data-custom-class="heading_2"]),
  .termly-policy :global([data-custom-class="heading_2"] *),
  .termly-policy :global([data-custom-class="link"]),
  .termly-policy :global([data-custom-class="link"] *) {
    font-family: inherit !important;
  }

  /* Hide the Termly logo/badge */
  .termly-policy :global(span[style*="11.125rem"]) {
