...
<svelte:head>
  <title
    ...
    {data.hike.name} - Adventure Spark</title
  >
</svelte:head>
    ...
    {#if isAdmin}
      <div class="mt-6 bg-white shadow rounded-lg p-6 border border-red-200">
        ...
        <p class="text-sm text-gray-600 mb-4">
          Permanently delete this hike and all associated images. This cannot be undone.
        </p>
        ...
        {:else}
          <p class="text-sm font-medium text-red-800 mb-3">
            Are you sure? This will permanently delete "{data.hike.name}" and all its images.
          </p>
          <form
            method="POST"
            action="?/delete"
