<script lang="ts">
  ...
  $: imageFiles =
    data.files?.filter((f: { fileType: string }) => f.fileType === "image") ||
    [];
  $: nonImageFiles =
    data.files?.filter((f: { fileType: string }) => f.fileType !== "image") ||
    [];
          ...
          {#if data.hike.distance}
            <span class="flex items-center gap-1">
              ...
              {#if data.hike.elevation}
                &bull; {data.hike.elevation}{data.hike.elevationUnit ===
                "meters"
                  ? "m"
                  : "ft"}
              {/if}
    ...
    <Tabs {tabs} bind:activeTab fullWidth>
      ...
      {#if activeTab === "details"}
        <div class="space-y-6">
          ...
          <!-- Trail Information -->
          <Card variant="elevated" padding="lg">
            <h2 slot="header" class="text-xl font-semibold text-gray-900">
              Trail Information
            </h2>
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-gray-500">
                      {TRAIL_TYPE_LABELS[data.hike.trailType] ||
                        data.hike.trailType}
                    </p>
                  </div>
                </div>
