<script lang="ts">
    ...
    $: heroImage = data.files?.find(
        (f: { fileType: string }) => f.fileType === "image",
    );
    ...
    onMount(() => {
        ...
        if (
            hash &&
            ["details", "map", "reviews", "notes", "media"].includes(hash)
        ) {
            activeTab = hash;
        }
    });
            ...
            ? [
                  {
                      ...
                      value:
                          data.hike.distance +
                          " " +
                          (data.hike.distanceUnit === "kilometers"
                              ? "km"
                              : "mi"),
                  },
              ]
            ...
            ? [
                  {
                      ...
                      value:
                          data.hike.elevation +
                          " " +
                          (data.hike.elevationUnit === "meters" ? "m" : "ft"),
                  },
              ]
            : []),
        ...(data.hike.duration
...
<div class="min-h-screen bg-gray-100/60">
    <div class="max-w-6xl mx-auto px-4 py-6 space-y-8">
        ...
        <div class="relative rounded-2xl overflow-hidden shadow-lg">
            ...
            {:else}
                <div
                    class="w-full h-80 bg-gradient-to-br from-green-400 via-emerald-500 to-teal-600"
                >
                ...
                <div class="flex flex-wrap gap-4 text-sm text-white/90">
                    ...
                    {#if data.hike.distance}
                        <span class="flex items-center gap-1">
                            ...
                            {#if data.hike.elevation}
                                &bull; {data.hike.elevation}{data.hike
                    ...
                    {#if data.hike.duration}
                        <span class="flex items-center gap-1">
                            <Clock size={16} />
                            ~{data.hike.duration}
                            {data.hike.durationUnit === "minutes"
                                ? "min"
                                : "hr"}
                        </span>
                    {/if}
                    {#if data.ratingAggregate}
                        ...
                        >
                            ...
                            {parseFloat(
                                String(data.ratingAggregate.averageRating),
                            ).toFixed(1)}
                            <span class="text-white/70"
                                >({data.ratingAggregate.totalRatings})</span
                            >
                        </button>
                    {/if}
                </div>
        ...
        <Tabs {tabs} bind:activeTab fullWidth>
            ...
            {#if activeTab === "details"}
                <div class="space-y-6">
                    <!-- About -->
                    <DescriptionSection
                        description={data.hike.description}
                    ...
                    <Card variant="elevated" padding="lg">
                        ...
                        <div
                            class="grid md:grid-cols-2 gap-x-8 gap-y-5 text-sm"
                        >
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500">
                                        {data.hike.permitsRequired ||
                                            "Standard state park entry fee may apply."}
                                    </p>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500">
                                        {data.hike.parkingInfo ||
                                            "Free lot available. Arrive 10 minutes early."}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="mt-4 space-y-3">
                            <div class="text-sm text-gray-700">
                                ...
                                <p>
                                    ...
                                    {#if data.address.state}{data.address
                                            .state}{/if}
                            ...
                            <div class="flex gap-3">
                                <a
                                    href="https://www.openstreetmap.org/?mlat={data
                                        .address.latitude}&mlon={data.address
                                        .longitude}#map=15/{data.address
                            ...
                            <div class="pt-3 border-t border-gray-200">
                                ...
                                >
                                    {data.address.latitude}, {data.address
                                        .longitude}
                                </p>
                            </div>
                        </div>
